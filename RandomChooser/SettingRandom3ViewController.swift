//
//  SettingRandom3ViewController.swift
//  RandomChooser
//
...
class SettingRandom3ViewController: UIViewController {
    ...
    @IBAction func goToResultPage(){
        ...
        let options = [option1.text, option2.text, option3.text].shuffled()

        
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        
        let resultVC = storyboard.instantiateViewController(identifier: "Result3VC") as! Result3ViewController
